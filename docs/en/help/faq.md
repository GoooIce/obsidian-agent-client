...
See [Note Mentions](/en/usage/mentions) for details.
...
See [Multi-Session Chat](/en/usage/multi-session) for details.
...
Any ACP-compatible agent beyond the built-in ones (Claude Code, Codex, Gemini CLI). You can add custom agents in **Settings → Agent Client → Custom agents**. See [Custom Agents](/en/agent-setup/custom-agents).
...
See [Session History](/en/usage/session-history) for details.
...
1. Check the [Troubleshooting](/en/help/troubleshooting) page
2. Search [GitHub Issues](https://github.com/GoooIce/obsidian-agent-client/issues)
3. Open a new issue if your problem isn't covered

### How do I report a bug?

[Open an issue on GitHub](https://github.com/GoooIce/obsidian-agent-client/issues/new) with:
