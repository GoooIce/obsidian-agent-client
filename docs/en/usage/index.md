...
See [Sending Images](/en/usage/sending-images) for more details.
...
See [Multi-Session Chat](/en/usage/multi-session) for details on:
...
See [Floating Chat](/en/usage/floating-chat) for details.
